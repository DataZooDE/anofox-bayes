...
| `nuts` | Explores the posterior itself with Hamiltonian dynamics. No closed form needed. | available on `pooled_gaussian` |
...
`pooled_gaussian` all three engines describe the same posterior by different routes,
